...
class ToBeDoneTableViewController: UITableViewController {
    ...
    @IBOutlet var toBeDoneTableView: UITableView!
    ...
    override func viewDidLoad() {
        ...
        for item in dict_ToDoList{
            ...
            if(val[0] == "NO"){
                toBeDoneTasks.append(name as! String)
            }
        }
        
        toBeDoneTasks.sort{ $0 < $1}
        
        toBeDoneTableView.reloadData()
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "ToBeDoneList", for: indexPath)
        let rowNumber: Int = (indexPath as NSIndexPath).row    // Identify the row number
        
        // Obtain the country code of the row
        let toDoName: String = toBeDoneTasks[rowNumber]
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        // Obtain the country code of the row
        let toDoItem: String = toBeDoneTasks[rowNumber]
